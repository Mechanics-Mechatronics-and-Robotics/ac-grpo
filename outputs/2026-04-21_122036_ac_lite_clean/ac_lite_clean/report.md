...
Source folder: `G:\ac-grpo\outputs\2026-04-21_122036_ac_lite_clean\ac_lite_clean`
...
|---|---|---:|---:|---:|---:|
| CLEAN | AC_LITE | 274.9 ± 11.9 | 0.970 ± 0.045 | 283.7 | 0.990 |

## Per-seed finals (last 20 episodes)

| mode | method | seed | final return | final success |
|---|---|---:|---:|---:|
| CLEAN | AC_LITE | 0 | 285.7 | 1.000 |
| CLEAN | AC_LITE | 3 | 255.1 | 0.900 |
| CLEAN | AC_LITE | 9 | 275.0 | 1.000 |
| CLEAN | AC_LITE | 17 | 275.9 | 0.950 |
| CLEAN | AC_LITE | 42 | 282.8 | 1.000 |
...
|---|---|---:|---|---:|---:|
| CLEAN | AC_LITE | 0 | AC_LITE_CLEAN_seed0_step0010000_policy.pt | 286.3 | 1.000 |
| CLEAN | AC_LITE | 3 | checkpoint_0_pretrained | 285.9 | 1.000 |
| CLEAN | AC_LITE | 9 | checkpoint_0_pretrained | 285.9 | 1.000 |
| CLEAN | AC_LITE | 17 | AC_LITE_CLEAN_seed17_step0010000_policy.pt | 287.3 | 1.000 |
