...
Source folder: `G:\ac-grpo\outputs\2026-04-22_231909_all_experiments\baseline_dense_clean`
...
- CLEAN: `BASELINE_DENSE` has the highest mean final return (263.0) with mean final success 0.920.
...
- test_clean (CLEAN, sigma=0.10): best mean return is `BASELINE_DENSE` in `CLEAN` with 277.9 ± 20.8 and success 1.000 ± 0.000.
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `BASELINE_DENSE` in `CLEAN` with 220.2 ± 105.3 and success 0.746 ± 0.436.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `BASELINE_DENSE` in `CLEAN` with 24.8 ± 36.3 and success 0.000 ± 0.000.
