...
Source folder: `G:\ac-grpo\outputs\2026-04-22_231909_all_experiments\baseline_sparse_clean`
...
- CLEAN: `BASELINE_SPARSE` has the highest mean final return (256.4) with mean final success 0.910.
...
- test_clean (CLEAN, sigma=0.10): best mean return is `BASELINE_SPARSE` in `CLEAN` with 277.7 ± 19.6 and success 1.000 ± 0.000.
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `BASELINE_SPARSE` in `CLEAN` with 205.9 ± 112.9 and success 0.693 ± 0.462.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `BASELINE_SPARSE` in `CLEAN` with 22.2 ± 31.3 and success 0.000 ± 0.000.
