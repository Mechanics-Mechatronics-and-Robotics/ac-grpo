...
Source folder: `G:\ac-grpo\outputs\2026-04-23_235329_all_experiments\ac_lite_sparse_reward_noise`
...
| AC-LITE (Sparse) | n/a | n/a | 120.8 ± 109.2 / 0.284 ± 0.451 |
...
|---|---|---:|---:|
| REWARD_NOISE | AC_LITE_SPARSE | 0.484 | 0.309 |
...
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 120.8 ± 109.2 and success 0.284 ± 0.451.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 3.6 ± 34.8 and success 0.000 ± 0.000.
