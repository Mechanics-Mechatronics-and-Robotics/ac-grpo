...
Source folder: `G:\ac-grpo\outputs\2026-04-23_002939_all_experiments\ac_full_sparse_reward_noise`
...
- REWARD_NOISE: `AC_FULL_SPARSE` has the highest mean final return (260.6) with mean final success 0.760.
...
- test_clean (CLEAN, sigma=0.10): best mean return is `AC_FULL_SPARSE` in `REWARD_NOISE` with 277.2 ± 24.9 and success 0.988 ± 0.111.
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `AC_FULL_SPARSE` in `REWARD_NOISE` with 204.2 ± 112.5 and success 0.680 ± 0.467.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `AC_FULL_SPARSE` in `REWARD_NOISE` with 21.5 ± 33.4 and success 0.000 ± 0.000.
