...
Source folder: `G:\ac-grpo\outputs\2026-04-23_002939_all_experiments\ac_lite_sparse_reward_noise`
...
- REWARD_NOISE: `AC_LITE_SPARSE` has the highest mean final return (242.1) with mean final success 0.640.
...
- test_clean (CLEAN, sigma=0.10): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 274.4 ± 36.3 and success 0.980 ± 0.140.
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 192.5 ± 117.2 and success 0.630 ± 0.483.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 18.0 ± 30.5 and success 0.000 ± 0.000.
