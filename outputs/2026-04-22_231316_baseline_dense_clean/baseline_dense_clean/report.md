...
Source folder: `G:\ac-grpo\outputs\2026-04-22_231316_baseline_dense_clean\baseline_dense_clean`
...
|---|---|---:|---:|---:|---:|
| CLEAN | BASELINE_DENSE | n/a | n/a | 262.1 | 0.917 |

## Per-seed finals (last 20 episodes)

| mode | method | seed | final return | final success |
|---|---|---:|---:|---:|
| CLEAN | BASELINE_DENSE | 42 | 262.1 | 0.917 |
...
|---|---|---|---|---:|---:|---:|
| CLEAN | BASELINE_DENSE | test_clean | CLEAN | 0.10 | 277.4 ± 20.7 | 1.000 ± 0.000 |
| CLEAN | BASELINE_DENSE | test_obs_noise | OBS_NOISE | 0.10 | 212.1 ± 111.1 | 0.710 ± 0.456 |
| CLEAN | BASELINE_DENSE | test_obs_noise_hard | OBS_NOISE | 0.20 | 21.7 ± 31.0 | 0.000 ± 0.000 |

## Result analysis

The final training-window summary shows the following strongest method per mode:

- CLEAN: `BASELINE_DENSE` has the highest mean final return (262.1) with mean final success 0.917.

Checkpoint selection versus the pretrained anchor:

- CLEAN / BASELINE_DENSE: checkpoint 0 wins in 1 of 1 seeds (1.00).

Best-checkpoint challenge testing:

- test_clean (CLEAN, sigma=0.10): best mean return is `BASELINE_DENSE` in `CLEAN` with 277.4 ± 20.7 and success 1.000 ± 0.000.
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `BASELINE_DENSE` in `CLEAN` with 212.1 ± 111.1 and success 0.710 ± 0.456.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `BASELINE_DENSE` in `CLEAN` with 21.7 ± 31.0 and success 0.000 ± 0.000.
