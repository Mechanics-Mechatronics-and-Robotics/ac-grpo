...
Source folder: `G:\ac-grpo\outputs\2026-04-23_013020_all_experiments\ac_lite_dense_obs_noise`
...
- test_clean (CLEAN, sigma=0.10): best mean return is `AC_LITE_DENSE` in `OBS_NOISE` with 256.2 ± 37.6 and success 0.956 ± 0.205.
...
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `AC_LITE_DENSE` in `OBS_NOISE` with 118.5 ± 95.2 and success 0.230 ± 0.421.
