...
Source folder: `G:\ac-grpo\outputs\2026-04-23_013020_all_experiments\ac_lite_sparse_reward_noise`
...
- REWARD_NOISE: `AC_LITE_SPARSE` has the highest mean final return (239.9) with mean final success 0.650.
...
- test_clean (CLEAN, sigma=0.10): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 277.7 ± 19.1 and success 1.000 ± 0.000.
- test_obs_noise (OBS_NOISE, sigma=0.10): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 166.7 ± 120.1 and success 0.510 ± 0.500.
- test_obs_noise_hard (OBS_NOISE, sigma=0.20): best mean return is `AC_LITE_SPARSE` in `REWARD_NOISE` with 13.1 ± 32.3 and success 0.000 ± 0.000.
