...
Source folder: `G:\ac-grpo\outputs\2026-04-21_115236_ac_lite_clean\ac_lite_clean`
...
|---|---|---:|---:|---:|---:|
| CLEAN | AC_LITE | 262.4 ± 22.9 | 0.910 ± 0.147 | 273.9 | 0.960 |

## Per-seed finals (last 20 episodes)

| mode | method | seed | final return | final success |
|---|---|---:|---:|---:|
| CLEAN | AC_LITE | 0 | 270.3 | 0.950 |
| CLEAN | AC_LITE | 3 | 223.6 | 0.650 |
| CLEAN | AC_LITE | 9 | 262.9 | 0.950 |
| CLEAN | AC_LITE | 17 | 283.5 | 1.000 |
| CLEAN | AC_LITE | 42 | 271.9 | 1.000 |
...
|---|---|---:|---|---:|---:|
| CLEAN | AC_LITE | 0 | AC_LITE_CLEAN_seed0_step0010000_policy.pt | 288.4 | 1.000 |
| CLEAN | AC_LITE | 3 | AC_LITE_CLEAN_seed3_step0010000_policy.pt | 287.2 | 1.000 |
| CLEAN | AC_LITE | 9 | checkpoint_0_pretrained | 285.9 | 1.000 |
| CLEAN | AC_LITE | 17 | AC_LITE_CLEAN_seed17_step0010000_policy.pt | 286.7 | 1.000 |
