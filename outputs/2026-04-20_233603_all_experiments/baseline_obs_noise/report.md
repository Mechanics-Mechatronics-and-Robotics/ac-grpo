...
Source folder: `G:\ac-grpo\outputs\2026-04-20_233603_all_experiments\baseline_obs_noise`
...
|---|---|---:|---:|---:|---:|
| OBS_NOISE | BASELINE | 149.5 ± 31.9 | 0.460 ± 0.134 | 198.4 | 0.660 |

## Per-seed finals (last 20 episodes)

| mode | method | seed | final return | final success |
|---|---|---:|---:|---:|
| OBS_NOISE | BASELINE | 0 | 169.7 | 0.550 |
| OBS_NOISE | BASELINE | 3 | 135.4 | 0.450 |
| OBS_NOISE | BASELINE | 9 | 151.5 | 0.450 |
| OBS_NOISE | BASELINE | 17 | 103.8 | 0.250 |
| OBS_NOISE | BASELINE | 42 | 186.7 | 0.600 |
...
|---|---|---:|---|---:|---:|
| OBS_NOISE | BASELINE | 0 | BASELINE_OBS_NOISE_seed0_final.pt | 247.2 | 0.800 |
| OBS_NOISE | BASELINE | 3 | BASELINE_OBS_NOISE_seed3_step0020000.pt | 220.4 | 0.733 |
| OBS_NOISE | BASELINE | 9 | BASELINE_OBS_NOISE_seed9_final.pt | 238.0 | 0.733 |
| OBS_NOISE | BASELINE | 17 | BASELINE_OBS_NOISE_seed17_final.pt | 225.5 | 0.667 |
| OBS_NOISE | BASELINE | 42 | BASELINE_OBS_NOISE_seed42_step0010000.pt | 277.5 | 0.933 |
